class Game {
  ...
  displayRank(){
    ...
    image(silverImg, windowWidth/4, windowHeight/10, 225, 270);
    image(bronzeImg, windowWidth/-4, windowHeight/9, 200, 240);
