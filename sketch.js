...
var obstacles;
var s;
var finishedPlayers,userFinished, rank;
var form, player, game;
var upA, downA, leftA, rightA, up, left, right;
...
function draw(){
   ...
   if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|OperaMine/i.test(navigator.userAgent)){
